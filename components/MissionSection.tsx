...
export function MissionSection() {
  return (
    <section id="mission" className="relative border-b border-border/50 bg-[rgb(var(--bg-page))] py-16 sm:py-20" aria-labelledby="mission-title">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <p className="text-caption font-medium uppercase tracking-widest text-accent">What we stand for</p>
