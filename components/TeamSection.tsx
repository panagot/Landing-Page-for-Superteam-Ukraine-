...
const members = [
  { id: '1', name: 'Core team', role: 'Community & ecosystem', placeholder: true },
  { id: '2', name: 'Builders', role: 'Mentors & leads', placeholder: true },
  { id: '3', name: 'Partners', role: 'Solana & Superteam', placeholder: true },
];
...
export function TeamSection() {
  return (
    <section
      id="team"
      className="border-b border-border/50 bg-[rgb(var(--surface))] py-16 sm:py-20"
